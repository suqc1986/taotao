...
public class TestActiveMq {  
    private static final String Activemq_URL= "tcp://192.168.137.150:61616";
    @Test  
    public void testQueueProducer() throws JMSException{  
        ...
        ConnectionFactory connectionFactory = new ActiveMQConnectionFactory("tcp://192.168.137.150:61616");  
...
//      textMessage.setText("hello,activemq!!!");  
        //第二种方式：  
        TextMessage textMessage = session.createTextMessage("hello,activemq!!suqc");  
        //8.发送消息  
