...
public class TestFreeMarker {  
    ...
    public void testFreeMarker1() throws Exception{  
    	...
    	configuration.setDirectoryForTemplateLoading(
    			new File("F:/workspace/taotao/taotao-item-web/src/main/webapp/WEB-INF/ftl"));  
    	//4.设置模板的字符集，一般为utf-8  
    	configuration.setDefaultEncoding("utf-8");  
    	//5.使用Configuration对象加载一个模板文件，需要指定模板文件的文件名。  
    	...
    	Map data = new HashMap<>();  
    	data.put("hello", "hello freemarker");
    	Student student = new Student(1,"张三",20,"北京市海淀区昌平区");
    	...
    	data.put("var", 123);
    	//7.创建一个Writer对象，指定输出文件的路径及文件名  
    	Writer out = new FileWriter(new File("F:/workspace/taotao/taotao-item-web/src/main/webapp/html/student.html"));  
    	//8.使用模板对象的process方法输出文件  
    	template.process(data, out);  
    	//9.关闭流  
    	out.close();  
